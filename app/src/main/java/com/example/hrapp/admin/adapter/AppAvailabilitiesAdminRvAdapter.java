...
import com.example.hrapp.admin.applications.ViewJobApplications;
...
public class AppAvailabilitiesAdminRvAdapter extends RecyclerView.Adapter<AppAvailabilitiesAdminRvAdapter.ViewHolder> {
    ...
    public AppAvailabilitiesAdminRvAdapter(Context context, LinkedList<Models.Applications> applicationList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
     ...
     /*   try {
        ...
        holder.apply.setText("View Applications");
        holder.apply.setOnClickListener(v -> mContext.startActivity(new Intent(mContext, ViewJobApplications.class).putExtra(APP_ID,applicationList.get(position).getAppId())));
    }
